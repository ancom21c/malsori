...
|---|---|---|---|---|---|---|---|---|
| T201 | P0 | Cloud Realtime 계약 정렬 (RTZR spec) | Done | Done | Done | Done | Done | `docs/todo/2026-03-03-spec-implementation-design-loop/T201-cloud-realtime-contract-alignment.md` |
...
| T203 | P1 | Backend Admin UI 내부망 운영 정책 정렬 | Done | Done | Done | Done | Done | `docs/todo/2026-03-03-spec-implementation-design-loop/T203-backend-admin-internal-surface.md` |
| T204 | P1 | 접근성/키보드 조작성 정합성 보강 | Done | Done | Done | Done | Done | `docs/todo/2026-03-03-spec-implementation-design-loop/T204-accessibility-keyboard-semantics.md` |
| T205 | P2 | 로케일 날짜/시간 표기 및 문서 lang 정렬 | Done | Done | Done | Done | Done | `docs/todo/2026-03-03-spec-implementation-design-loop/T205-locale-formatting-html-lang.md` |
...
| T208 | P2 | Connection HUD + Empty State 디자인 적용 | Done | Done | Done | Done | Done | `docs/todo/2026-03-03-spec-implementation-design-loop/T208-connection-hud-empty-state.md` |
