...
|---|---|---|---|---|---|---|---|---|
| T001 | P0 | 운영 API 계약 점검/정렬 | Done | Pending | Pending | Pending | Pending | `docs/todo/2026-02-19-execution-loop/T001-api-contract.md` |
| T002 | P0 | 배포 후 스모크 자동화 | Done | Pending | Pending | Pending | Pending | `docs/todo/2026-02-19-execution-loop/T002-post-deploy-smoke.md` |
| T003 | P1 | CI 품질 게이트 강화 | Done | Pending | Pending | Pending | Pending | `docs/todo/2026-02-19-execution-loop/T003-ci-quality-gates.md` |
| T004 | P1 | Realtime 지연/재연결 UX | Done | Pending | Pending | Pending | Pending | `docs/todo/2026-02-19-execution-loop/T004-realtime-latency-reconnect.md` |
