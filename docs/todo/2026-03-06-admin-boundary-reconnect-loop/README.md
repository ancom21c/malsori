...
|---|---|---|---|---|---|---|---|---|
| T601 | P0 | Public/Internal API boundary split + default base 정리 | Done | Done | Pending | Pending | Pending | `docs/todo/2026-03-06-admin-boundary-reconnect-loop/T601-public-internal-api-boundary.md` |
