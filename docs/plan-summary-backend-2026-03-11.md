...
- 완료: `T1001` summary partition / artifact contract implementation + review + verify
- 완료: `T1002` summary preset library + auto-selection contract implementation + review + verify
- 완료: `T1003` summary surface UX for realtime/detail implementation + review + verify
- 완료: `T1004` summary runtime freshness + regeneration lifecycle implementation + review + verify
- 현재 open work: `T1005`~`T1007`
