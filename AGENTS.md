...
- `docs/plan-operator-feature-activation-2026-03-11.md` - current execution plan for operator activation and summary/translate work
...
- Current active execution loop: `docs/plan-operator-feature-activation-2026-03-11.md` and `docs/todo/2026-03-11-operator-feature-activation-loop/README.md`.
